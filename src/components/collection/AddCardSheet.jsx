...
export default function AddCardSheet({
  ...
  // Atualiza o formulário sempre que outra carta for aberta.
  useEffect(() => {
    if (!card || !open) return;
  ...
  return (
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent
        side="bottom"
        className="bg-card border-border/50 rounded-t-2xl max-h-[90vh] overflow-y-auto"
      >
        ...
        <div className="flex gap-4 mb-5 p-3 glass rounded-xl">
          {image && (
            <img
              src={image}
              alt={card?.name || card?.card_name || "Carta"}
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="near_mint">
                    Near Mint
                  </SelectItem>

                  <SelectItem value="lightly_played">
                    Lightly Played
                  </SelectItem>

                  <SelectItem value="moderately_played">
                    Moderately Played
                  </SelectItem>

                  <SelectItem value="heavily_played">
                    Heavily Played
                  </SelectItem>
                </SelectContent>
              </Select>
